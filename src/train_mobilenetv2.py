...
with open(report_path, 'w', encoding='utf-8') as f:
    ...
    f.write("  - Dense(256, activation='relu')\n")
    ...
    f.write("=" * 80 + "\n\n")
    f.write(f"Modelo salvo em: ./model/modelo_mobilenetv2_224x224_finetuned.keras\n")
...
model.save("./model/modelo_mobilenetv2_224x224_finetuned.keras")
...
print("=" * 80)
print(f"Modelo salvo em: ./model/modelo_mobilenetv2_224x224_finetuned.keras")
